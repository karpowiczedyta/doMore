...
export class ChartsComponent implements OnInit {
  ...
  summaryByDay() {
    ...
    this.chartService.postDateByDay(dateToSearch).subscribe(
      res => {
        this.timePerDay = res;
        this.dateS = res.date;
      },
  ...
  summaryByWeek() {
    ...
    let newDate = new Date(this.date);
    this.dateS = newDate.toLocaleDateString();//thisss
    let newTime = newDate.toTimeString();
    console.log("newdate" + newDate);
    console.log("time" + newTime);
    console.log("dateSDoWysyłki i przetworzenia :: " + this.dateS);
    ...
    this.chartService.postDateByWeek(dateToSearch).subscribe(
      res => {
  ...
  summaryByMonth() {
    ...
    this.chartService.postDateByMonth(dateToSearch).subscribe(
      res => {
  ...
  summaryByYear() {
    ...
    this.chartService.postDateByYear(dateToSearch).subscribe(
      res => {
        this.timePerMonth = res;
  ...
  previousDate() {
    if (this.isDate === true && this.isWeek === false && this.isMonth === false && this.isYear === false) {
      ...
      this.chartService.postDateByDayPrevious(dateToSearch).subscribe(
        res => {
      ...
      this.chartService.postDateByWeekPrevious(dateToSearch).subscribe(
        res => {
          this.timePerWeek = res;
          this.dateS = res[0].date;
        },
      ...
      this.chartService.postDateByMonthPrevious(dateToSearch).subscribe(
        res => {
          this.timePerMonth = res;
      ...
      this.chartService.postDateByYearPrevious(dateToSearch).subscribe(
        res => {
          this.timePerMonth = res;
          console.log(this.timePerMonth[0].date);
          console.log(this.timePerMonth[0].time);
  ...
  forwardDate() {
    if (this.isDate === true && this.isWeek === false && this.isMonth === false && this.isYear === false) {
      ...
      this.chartService.postDateByDayNext(dateToSearch).subscribe(
        res => {
          this.timePerDayA = res;
          this.dateS = res[0].date;
        },
      ...
      this.chartService.postDateByMonthNext(dateToSearch).subscribe(
        res => {
          this.timePerMonth = res;
          console.log(res[0].date)
          this.dateS = res[0].date;
      ...
      this.chartService.postDateByYearNext(dateToSearch).subscribe(
        res => {
          this.timePerMonth = res;
          console.log(this.timePerMonth[0].date);
          console.log(this.timePerMonth[0].time);
