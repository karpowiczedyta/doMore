...
public class ChartsService {
    ...
    public ChartsService(CounterUpTimerRepository counterUpTimerRepository, BreakRepository breakRepository) {
    ...
    public List<ChartsViewModel> dateAndTimePerWeek(ChartsViewModel search) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            hours = this.counterUpTimerRepository
                    .countHours(search.getEducationStage(), search.getName(), search.getActualYear(), dayOfWeek)
                    .orElse(0);
            minutes = this.counterUpTimerRepository
                    .countMinutes(search.getEducationStage(), search.getName(), search.getActualYear(), dayOfWeek)
                    .orElse(0);
            seconds = this.counterUpTimerRepository
                    .countSeconds(search.getEducationStage(), search.getName(), search.getActualYear(), dayOfWeek)
                    .orElse(0);
    ...
    public ChartsViewModel dateAndTimePerThisDate(ChartsViewModel search) {
        ...
        Integer hours = this.counterUpTimerRepository
                .countHours(search.getEducationStage(), search.getName(), search.getActualYear(), dateToSearch)
                .orElse(0);
        Integer minutes = this.counterUpTimerRepository
                .countMinutes(search.getEducationStage(), search.getName(), search.getActualYear(), dateToSearch)
                .orElse(0);
        Integer seconds = this.counterUpTimerRepository
                .countSeconds(search.getEducationStage(), search.getName(), search.getActualYear(), dateToSearch)
                .orElse(0);
